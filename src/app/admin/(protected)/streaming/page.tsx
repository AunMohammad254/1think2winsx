...
import { DynamicLiveStreamManager } from '@/components/admin/DynamicAdminComponents';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4 py-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-white">Live Streaming</h1>
                                <p className="text-gray-400 text-sm">Manage livestream embed configuration</p>
                            </div>
                        </div>
                    </div>
                </div>
